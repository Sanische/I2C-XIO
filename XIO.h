...
public:
	...
	void xioMaskSet(byte pin, boolean value);
	void xioMaskSetCached(byte pin, boolean value);
	void xioPolaritySet(byte pin, boolean value);
	void xioPolaritySetCached(byte pin, boolean value);
	void xioMODE(boolean smba, boolean ioac, boolean och, boolean oepol);
	void xioOUTCONF(boolean out4, boolean out3, boolean out2, boolean out1,
		boolean out067, boolean out045, boolean out023, boolean out001);
	void xioALLBNK(boolean bsel, boolean b4, boolean b3, boolean b2, boolean b1, boolean b0);
	void refreshIO();
	void refreshPinModes();
	void refreshMaskInterrupt();
	void refreshPolarityInversion();
	byte getInput(byte bank);
	byte getSMBA();
	uint8_t currentInputStates[5];
	uint8_t lastInputStates[5];
...
private:
	...
	uint8_t maskInterruptState[5];
	uint8_t polarityInversion[5];
	int8_t dioReset;
	...
	void sendMaskInterrupt(byte bank);
	void sendPolarityInversion(byte bank);
};
